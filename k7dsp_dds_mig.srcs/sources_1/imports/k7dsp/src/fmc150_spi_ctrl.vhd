...
-- Luc Langlois
-- Dec 19, 2011:
--       - modified for ADC auto-calibration
--       -... brought out signals 'init_amc7823_done' and 'odata_valid' as ports
--
-------------------------------------------------------------------------------------
...
begin
  if (rising_edge(clk)) then
    ...
    if (cdce72010_out_cmd_val = '1') then
	 ...
	 odata_valid <= cdce72010_out_cmd_val or 
		ads62p49_out_cmd_val or 
		dac3283_out_cmd_val or 
		amc7823_out_cmd_val;
...
init_amc7823_done <= init_done_amc7823;
----------------------------------------------------------------------------------------------------
