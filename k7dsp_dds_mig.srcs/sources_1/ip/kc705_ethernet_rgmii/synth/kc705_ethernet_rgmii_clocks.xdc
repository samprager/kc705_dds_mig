...
create_clock -name kc705_ethernet_rgmii_rgmii_rx_clk -period 8

# Identify RGMII Rx Pads only.  
# This prevents setup/hold analysis being performed on false inputs,
# eg, the configuration_vector inputs.

set_input_delay -clock [get_clocks kc705_ethernet_rgmii_rgmii_rx_clk] -max -1.5 [get_ports {rgmii_rxd[*] rgmii_rx_ctl}]
set_input_delay -clock [get_clocks kc705_ethernet_rgmii_rgmii_rx_clk] -min -2.8 [get_ports {rgmii_rxd[*] rgmii_rx_ctl}]
set_input_delay -clock [get_clocks kc705_ethernet_rgmii_rgmii_rx_clk] -clock_fall -max -1.5 -add_delay [get_ports {rgmii_rxd[*] rgmii_rx_ctl}]
set_input_delay -clock [get_clocks kc705_ethernet_rgmii_rgmii_rx_clk] -clock_fall -min -2.8 -add_delay [get_ports {rgmii_rxd[*] rgmii_rx_ctl}]

set_false_path -rise_from [get_clocks kc705_ethernet_rgmii_rgmii_rx_clk] -fall_to $rx_clk -setup
set_false_path -fall_from [get_clocks kc705_ethernet_rgmii_rgmii_rx_clk] -rise_to $rx_clk -setup
set_false_path -rise_from [get_clocks kc705_ethernet_rgmii_rgmii_rx_clk] -rise_to $rx_clk -hold
set_false_path -fall_from [get_clocks kc705_ethernet_rgmii_rgmii_rx_clk] -fall_to $rx_clk -hold

set_multicycle_path -from [get_clocks kc705_ethernet_rgmii_rgmii_rx_clk] -to $rx_clk -setup 0
set_multicycle_path -from [get_clocks kc705_ethernet_rgmii_rgmii_rx_clk] -to $rx_clk -hold -1

############################################################
# For Setup and Hold time analysis on RGMII outputs        #
############################################################

create_generated_clock -name rgmii_tx_clk -divide_by 1 -source [get_pins {rgmii_interface/rgmii_txc_ddr/C}] [get_ports rgmii_txc]
...
set_false_path -from [get_cells {kc705_ethernet_rgmii_core/*managen/conf/int_*reg[*]}] -to $ip_gtx_clk
set_false_path -from [get_cells {kc705_ethernet_rgmii_core/*managen/conf/int_*reg[*]}] -to $rx_clk
set_false_path -from [get_cells {kc705_ethernet_rgmii_core/*managen/conf/int_*reg}] -to $ip_gtx_clk
set_false_path -from [get_cells {kc705_ethernet_rgmii_core/*managen/conf/int_*reg}] -to $rx_clk
...
set_false_path -from $ip_cpu_clk -to  [get_cells {kc705_ethernet_rgmii_core/addr_filter_top/address_filter_inst/*addr*/bit_match*reg[*]}]
