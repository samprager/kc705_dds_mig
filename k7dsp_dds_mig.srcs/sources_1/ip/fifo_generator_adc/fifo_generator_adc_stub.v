...
//               /media/sf_VMLinux/Projects/UndergroundRadar/kc705_dds_mig/k7dsp_dds_mig.srcs/sources_1/ip/fifo_generator_adc/fifo_generator_adc_stub.v
...
/* synthesis syn_black_box black_box_pad_pin="rst,wr_clk,rd_clk,din[31:0],wr_en,rd_en,dout[63:0],full,almost_full,wr_ack,empty,almost_empty,valid,rd_data_count[13:0],wr_data_count[14:0]" */;
  input rst;
  input wr_clk;
  input rd_clk;
  input [31:0]din;
