...
catch { write_hwdef -file ila_axis_adc_pkt.hwdef }
synth_design -top ila_axis_adc_pkt -part xc7k325tffg900-2 -mode out_of_context

rename_ref -prefix_all ila_axis_adc_pkt_
